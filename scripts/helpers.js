...
(function uiSanitizer(){
  ...
  function run(){ cleanHeader(); overrideFairness(); observeFilter(); sweepSeparators(); ensureFairnessAutoRefresh(); ensureFairnessMobileStyles(); ensureFairnessVisibilityObserver(); }
